...
public:
	...
	*/
	...
	{
		ExecuteSFWQuery(valuesToSelect, tablesToProcess, allDisjunctions, groupingClauses, catelog, bufferMgr, allTableReaderWriters, allBPlusReaderWriters);
	}
...
public:
	...
	void executeSFWQuery(
		...
		map <string, MyDB_TableReaderWriterPtr>& allTableReaderWriters,
		map <string, MyDB_BPlusTreeReaderWriterPtr>& allBPlusReaderWriters) {
		myQuery.execute(catelog, bufferMgr, allTableReaderWriters, allBPlusReaderWriters);
	}
